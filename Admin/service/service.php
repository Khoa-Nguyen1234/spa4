    ...
    <body>
        ...
        <section id="sidebar">
            ...
            <ul class="side-menu">
                ...
                <li>
                    <a href="./service.php" class="service-link"><i class='bx bxs-inbox icon'></i> Quản lý dịch vụ <i class='bx bx-chevron-right icon-right'></i></a>
                    <ul class="side-dropdown">
                        <li><a href="./add_service.php">Thêm</a></li>
                    </ul>
                </li>
